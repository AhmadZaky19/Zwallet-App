...
const ChangePassword = ({navigation}) => {
  ...
  const {msg, user, isSuccess} = useSelector((state) => state.auth);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View>
        ...
        />
        {errors.password && (
          <Text style={styles.textFormError}>Password is required.</Text>
        )}
        <Controller
          control={control}
          render={({onChange, onBlur, value}) => (
        ...
        />
        {errors.newPassword && (
          <Text style={styles.textFormError}>New password is required.</Text>
        )}
        <Controller
          control={control}
          render={({onChange, onBlur, value}) => (
