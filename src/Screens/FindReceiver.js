    ...
    <Pressable
      ...
      <View style={styles.profileContainer}>
        ...
        <View style={styles.textHelloContainer}>
          {data.last_name === null ? (
            <Text
              style={styles.textNameTransaction}>{`${data.first_name}`}</Text>
          ) : (
            <Text
              style={
                styles.textNameTransaction
        ...
        <SectionList
          ...
          renderSectionHeader={({section: {date}}) => (
            <View style={styles.section}>
              ...
              <Text
                style={
                  styles.sectionTextSubtitle
                }>{`${contact.length} Contacts Found`}</Text>
            </View>
          )}
        />
      </View>
