      ...
      <ScrollView>
        ...
        <View style={styles.profileContainer}>
          <View style={styles.profileFlex}>
            <Image
              source={
                stateTransaction.receiver.photo === null
                  ? defaultProfile
                  : {uri: profilImg(stateTransaction.receiver.photo)}
              }
              style={styles.profileImg}
            />
            <View style={styles.textProfileContainer}>
              <Text style={styles.textName}>
                {stateTransaction.receiver.last_name === null
                  ? stateTransaction.receiver.first_name
                  : `${stateTransaction.receiver.first_name} ${stateTransaction.receiver.last_name}`}
              </Text>
              <Text style={styles.textPhone}>
                {stateTransaction.receiver.phone}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.profileContainer}>
          <View style={styles.textContainer}>
            ...
            <Text style={styles.textItem}>{`Rp${Number(
              stateTransaction.transaction.amount,
        ...
        <View style={styles.profileContainer}>
          <View style={styles.textContainer}>
            ...
            <Text style={styles.textItem}>{`Rp${(
              Number(currentUser.balance) -
              Number(stateTransaction.transaction.amount)
            ).toLocaleString('id-ID')}`}</Text>
          </View>
        </View>
        <View style={styles.profileContainer}>
          <View style={styles.textContainer}>
            ...
            <Text style={styles.textItem}>{`${DateTime.local()
              .setLocale('en')
              .toLocaleString(
                DateTime.DATE_MED,
              )} - ${DateTime.local()
              .setLocale('id')
              .toLocaleString(DateTime.TIME_SIMPLE)}`}</Text>
          </View>
        </View>
        <View style={styles.profileContainer}>
          <View style={styles.textContainer}>
            ...
            <Text style={styles.textItem}>
              {stateTransaction.transaction.notes === null
                ? '(No notes)'
                : stateTransaction.transaction.notes}
            </Text>
          </View>
        </View>
        <Button
